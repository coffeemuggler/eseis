...
#' than creating individual PSDs by time and by station.
#' 
#' The function calls a series of other functions, partly with modified 
#' default values, which can be changed by the ...-argument. The seismic
#' files are imported as eseis objects using 
