...
#' records all data manipulation of an (\code{eseis}) object. The element 
...
#' interval). Thus, working with (\code{eseis}) object is convenient and less 
...
#' will update the meta information whenever necesary (e.g., 
