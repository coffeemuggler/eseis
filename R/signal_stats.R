...
#' - (42) `"s_gamma1"` (Gamma 1 value of the spectrum, see Hibert et al. (2017))
#' - (43) `"s_gamma2"` (Gamma 2 value of the spectrum, see Hibert et al. (2017))
#' - (44) `"s_gamma3"` (Difference of gamma 1 and 2, see Hibert et al. (2017))
